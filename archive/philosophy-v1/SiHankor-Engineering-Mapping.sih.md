...
| 法则  | 力度 | 道一依据  | 说明                                           |
| ---- | ---- | --------- | ---------------------------------------------- |
| E-F-01 | 戒   | 收敛必-为 | 代码只能从 ratify 规范生成：：不自动生成就不收敛 |
| E-F-02 | 戒   | 收敛必-为 | 无上游不得建下游：：因果链不能断裂               |
| E-F-03 | 戒   | 有度      | require 和 spec 不得混行：：过度规约=刻意有为    |
| E-G-04 | 规   | 损补      | 同格 ratify 文档不超 3 个活跃版本：：损有余      |
| E-F-13 | 戒   | 知止      | iCL 不读取未声明路径：：治理有边界               |

### 2.2 道二 -> 法则

| 法则  | 力度 | 道二依据     | 说明                               |
| ---- | ---- | ------------ | ---------------------------------- |
| E-F-01 | 戒   | 意图先于代码 | 代码只能从规范生成：：因果方向不可逆 |
| E-F-02 | 戒   | 意图先于代码 | 无上游不得建下游：：因果链完整       |
| E-G-01 | 规   | 顺势         | propose->resolve 推进时限：：适时收敛 |

### 2.3 道三 -> 法则

| 法则      | 力度 | 道三依据 | 说明                                  |
| --------- | ---- | -------- | ------------------------------------- |
| E-F-01      | 戒   | 意图必复 | 规范显式化意图：：降低恢复成本          |
