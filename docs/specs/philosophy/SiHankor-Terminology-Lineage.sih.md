...
八个核心术语：自然、知止、损补、顺因、顺势、有度、鉴、应。其中顺因、有度、知止、损补、顺势属"收敛五法"（见 glossary 法条），自然为道层发散之然，鉴为内省之衡器，应为外应之柱石。
...
| 原文出处 | 《庄子》齐物论 |
| 原义 | 枢居环中以应无穷——圣人居于是非之中枢，不动而应万变 |
| 司衡用法 | 居中不动以应万变：应辨（当前形态）处理已抵达的外部挑战，应几（演进方向）感知正在形成的微兆。辨名、辨理、辨归三层次将挑战归位到正确通道 |
| 与原义关系 | 保留：义核（居中不动以应无穷）未变，延伸至工程治理的挑战回应与微兆感知 |

"应"作为道家术语，与"应而不藏"（庄子·应帝王）、"应而不倡"（庄子·齐物论）一脉相承。应的姿态是回应而非挑衅，是澄清而非裁决。应（Settle）为司衡第四柱石，与道、法、鉴并列：道立法，鉴照之，应守之。鉴内省（反推检验自己的主张），应外应（回应外部挑战），二者为认识论双翼。应的正名包含应辨与应几两种形态，对应不同的数据成熟度。

## 三、血统总览

八个核心术语的血统源出关系如下图。实线"原文"表示术语概念直接见于原典原文，虚线"延伸"表示术语为道家义理的延伸概念。
...
结论：八个核心术语中，六个直接引《道德经》《庄子》原文（自然、知止、损补、顺因、鉴、应），两个为道家义理延伸概念（顺势、有度），均无儒法家源头、无自造。原误判"60% 儒法家、20% 道家、20% 自造"不成立，道家血统纯正。
...
- 260627-1600-settle-on-recurring-challenges
  - 应论，应之柱石定位与挑战回应
  - [司衡应论](./Settle-On-Recurring-Challenges.sih.md)
- glossary/zh.yml
  - 源语言权威术语定义
  - [术语表](../../../glossary/zh.yml)
