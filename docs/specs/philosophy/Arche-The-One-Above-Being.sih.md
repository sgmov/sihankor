...
本文论元——不是元本身（元先于语言），而是元使道得以可能的条件。元论的价值不在于它论证了一个不可论证的对象，而在于它梳理了其他论文不讨论的条件层：道的发现需要什么前提？这些前提是如何被提及但未被系统化的？元论不要求超越论域——它诚实地承认自己是在论文。

元不可名而名：它在整个司衡体系的工程实践的沉默呼应中浮现，我们为其立名不是要论证它，而是要梳理道从何而来。命名是工程操作的需要：使元可被引用、讨论、检验。这类似于在学科基础课中讨论"什么是科学"——我们不是要定义科学本身（那是不可能的），而是要在教学操作中梳理科学研究的前提条件。

## 一、破题：何为元

### 1.1 元在司衡体系中的位置

元不在论域内——准确地说，元先于论。论以理辨，而元是理得以被辨别的构成性条件。但元论在论域内——它是关于这些条件的论文，不声称自己超越论域而获得特殊地位。当我们追问"道何以能被发现""鉴何以能区分真伪"，这些追问本身已经指向了某个使追问得以可能的条件域。对此条件域的梳理，就是本文的意图。
...
两者一为存在论奠基（元回答"道何以可能"），一为认识论奠基（鉴回答"道何以可信"），共同构成司衡的双重自觉。
