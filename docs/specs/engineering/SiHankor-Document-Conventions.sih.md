...
stage: 0/260628-1100-document-conventions
...
例外（依据 [C-10 nature 分级决策](../../decisions/260616-1930-format-lint-decision.sih.md)）：spec 和 decision 文档中的多维映射表（生命周期规则、道法映射、架构对照等）宽表降为 Warning——当表格自身的目的是结构呈现而非叙事可读性时，拆分反致不可读。
