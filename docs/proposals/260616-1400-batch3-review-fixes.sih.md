...
| 编号 | 变更 | 位置 |
|------|------|------|
| **B-24** | ① 意图定位追问："type/stage/upstream" → "nature/stage/upstream" | 行57 |
| **B-24** | ① 输出描述："type × stage × upstream 链" → "nature × stage × upstream 链" | 行58 |
| **B-25** | `governance_position` 注释："type × stage × upstream 链" → "nature × stage × upstream 链" | 行127 |
